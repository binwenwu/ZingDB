package top.tankenqi.zingdb.backend.dm.pageCache;
...
import top.tankenqi.zingdb.backend.utils.RandomUtil;
...
public class PageCacheTest {
    ...
    public void testPageCache() throws Exception {
        ...
        /**
         * 为什么循环 100 次：这是在测试“缓存容量为 50 的情况下，
         * 创建并持久化 100 个页”的行为，
         * 即便内存里最多只留得下 50 页（会发生淘汰），
         * 每个新页都会被写入磁盘，关闭重开后依然能读到全部 100 页的数据
         */
        for (int i = 0; i < 100; i++) {
